...
function Users() {
    ...
    const handleView = (user) => {
        navigate(`/account/users/${user._id}`);
    };
                    ...
                    return (
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 transition-colors">{user.email}</div>
                            </div>
                        </div>
                    );
                },
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            {totalCandidates > 0 ? (
                                    <span>
                                        ...
                                        <span className="font-semibold text-gray-900 dark:text-white">{totalCandidates}</span> users
                                    </span>
                                ) : (
                                    <span>0 users</span>
                                )}

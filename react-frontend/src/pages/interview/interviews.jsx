                                            ...
                                            return (
                                                <th
                                                    ...
                                                    className={`sticky top-0 z-20 bg-gray-50 dark:bg-gray-900 dark:bg-gray-800 px-6 py-3.5 font-semibold text-xs uppercase tracking-wider ${
                                                        canSort
                                                            ? "cursor-pointer select-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-700"
                                                            : ""
                                                    }`}
                                                >
                                    ...
                                    <tr>
                                        <td colSpan={columns.length} className="px-6 py-12 text-center text-gray-500 dark:text-gray-400 dark:text-gray-500 transition-colors">
                                            <div className="max-w-xs mx-auto space-y-2">
                                                ...
                                                <p className="font-semibold text-gray-700 dark:text-gray-300">No interviews found</p>
                                                <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 transition-colors">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-300 transition-colors">
                                {totalCandidates > 0 ? (
                                    <span>
                                        ...
                                        <span className="font-semibold text-gray-900 dark:text-white">{totalCandidates}</span> interviews
                                    </span>
                                ) : (

                ...
                cell: (info) => {
                    ...
                    return (
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="font-semibold text-gray-900 dark:text-white">{job.title || "N/A"}</div>
                                <div className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 transition-colors">{job.employeeType}</div>
                            </div>
                        </div>
                    );
                },
                                    ...
                                    <tr>
                                        <td colSpan={columns.length} className="px-6 py-12 text-center text-gray-500 dark:text-gray-400 dark:text-gray-500 transition-colors">
                                            <div className="max-w-xs mx-auto space-y-2">
                                                ...
                                                <p className="font-semibold text-gray-700 dark:text-gray-300">No jobs found</p>
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 dark:text-gray-300 transition-colors">
                                {totalCandidates > 0 ? (
                                    <span>
                                        ...
                                        <span className="font-semibold text-gray-900 dark:text-white">{totalCandidates}</span> jobs
                                    </span>
                                ) : (
                                    <span>0 jobs</span>
                                )}
